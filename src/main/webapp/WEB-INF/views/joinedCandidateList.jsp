...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Joined Candidate
			List</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Joined Candidate List Details</div>
													...
													<tr>
														...
														<td class="text-center">
															<c:if
																...
																<p class="btn btn-success btn-sm">Employee Joined</p>
															</c:if> 
															<c:if
																test="${candidate.status eq 7}">
																<p class="btn btn-success btn-sm">Waiting for Q1 FeedBack</p>
															</c:if>
															<c:if test="${candidate.status eq 8}">
																<p class="btn btn-info btn-sm">Q1 FeedBack
																	Successful</p>
															</c:if>
															<c:if
																test="${candidate.status eq 9}">
																<p class="btn btn-success btn-sm">Waiting for Q2 FeedBack</p>
															</c:if> <c:if test="${candidate.status eq 10}">
																<p class="btn btn-info btn-sm">Q2 FeedBack
																	Successful</p>
															</c:if>
															<c:if
																test="${candidate.status eq 11}">
																<p class="btn btn-success btn-sm">Waiting for Q3 FeedBack</p>
															</c:if> 
															<c:if test="${candidate.status eq 12}">
																<p class="btn btn-info btn-sm">Q3 FeedBack
