...
<body>
	...
	<div class="page-head">
		...
		<p class="red">On a scale of 1 to 5, where 1=Very Dissatisfied and
			5= Very Satisfied</p>
			...
			<div class="col-md-12">
				...
				<div class="widget wgreen">
					...
					<div class="widget-head">
						<div class="pull-left">
							<p class="blue">Candidate Name :
								${candidateAnswer.candidate.candName} , Candidate ID :
								${candidateAnswer.candidate.candId}, Employee Id :
								${candidateProfile.empId}, Company :
								${candidateAnswer.candidate.company.name}, Date of Joining :
								${candidateAnswer.candidate.dateOfJoin}</p>
						</div>
						...
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" class="form-horizontal">
								<div class="form-group">
									<label class="col-lg-3 control-label">1. How was your
										1st month experience with the organization?<span class="red">*</span>:
									</label>
									<div class="col-lg-5">
										<%-- <p class="bold" style="color:#00000; font-size:2em;"> ${candidateAnswer.answerOne} </p> --%>
										<c:if test="${candidateAnswer.answerOne eq 1}">
											<p class="bold" style="color: #00000; font-size: 2em;">Very
												Dissatisfied</p>
										</c:if>
										<c:if test="${candidateAnswer.answerOne eq 2}">
											<p class="bold" style="color: #00000; font-size: 2em;">Dissatisfied
											</p>
										</c:if>
										<c:if test="${candidateAnswer.answerOne eq 3}">
											<p class="bold" style="color: #00000; font-size: 2em;">Neither
												Satisfied Nor Dissatisfied</p>
										</c:if>
										<c:if test="${candidateAnswer.answerOne eq 4}">
											<p class="bold" style="color: #00000; font-size: 2em;">Satisfied
											</p>
										</c:if>
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">2. Are you
										satisfied with your Department/ Team?<span class="red">*</span>:
									</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">3. Are you
										enjoying your job?<span class="red">*</span>:
									</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">4. Are you
										satisfied with company\'s HR policies?<span class="red">*</span>:
									</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">5. Considering
										everything, are you happy to work with this organization?<span
										class="red">*</span>:
									</label>
									<div class="col-lg-5">
								...
								<hr />
								<div class="form-group">
									<label class="col-lg-3 control-label">6. Do you have
										any suggestion regarding our joining process? <span
										class="red">*</span>:
									</label>
									<div class="col-lg-5">
										<p class="bold" style="color: #00000; font-size: 2em;">
											${candidateAnswer.answerSix}</p>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-xs-8">
										<p class="bold blue center">
											NPS <span class="red">(On a scale of 1 to 10, where 0=
												Not at all likely and 10 = Extremely Likely) </span>
										</p>
									</div>
								</div>

								<div class="form-group">
									<label class="col-lg-3 control-label">7. How likely is
										it that you would recommend this company to a friend or
										relative? <span class="red">*</span>:
									</label>
									<div class="col-lg-5">
										<p class="bold" style="color: #00000; font-size: 2em;">
											${candidateAnswer.npsResult}</p>
									</div>
								</div>
