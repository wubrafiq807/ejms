...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Pending Candidate
			List</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Pending Candidate List Details</div>
													...
													<tr>
														...
														<td align="center">
															...
															<c:if test="${candidate.status eq 5}"> 
																...
																<%-- <c:if test="${candidate.status eq 14 && candidate.uploadAppLetter eq 1}"> 
