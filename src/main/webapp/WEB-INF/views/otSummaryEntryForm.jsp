...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Overtime Summary</h2>
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST"
								id="otSummaryEntryFormId" class="form-horizontal"
								modelAttribute="overtimeSummaryForm"
								action="${pageContext.request.contextPath}/generateOtSummary">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('.ai-save-update-btn').click(function() {
				...
				if (!flag) {
					w2confirm('Are you sure, Generate Overtime Summary for this Month, If Not Exists?', function btn(answer) {
					    if(answer == 'Yes'){
					    	$(".ai-save-update-btn").prop('disabled', true);
							$('#otSummaryEntryFormId').submit();
					    } else {
					    	$(".ai-save-update-btn").prop('disabled', false);
					    }
					});
