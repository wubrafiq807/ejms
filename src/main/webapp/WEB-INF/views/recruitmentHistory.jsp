...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Recruitment History</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Recruitment History</div>
							...
							<div class="widget-content">
								...
								<div class="table-responsive">
									...
									<c:if test="${!empty recruitmentHistory}">
										<table class="table table-bordered table-hover" id="table1">
											...
											<tbody>
												<c:forEach items="${recruitmentHistory}" var="candidate"
													varStatus="cand">
													<tr>
														...
														<td class="text-center"><c:if
																test="${candidate.status eq 13}">
																<p class="btn btn-success btn-sm">SUCCESSFULLY EMPLOYED</p>
															</c:if> </td>
														<td class="text-center">${candidate.remarks}</td>
														<td align="center">
															<a class="btn btn-sm btn-info custom-width" title="Profile View"
															...
															<a class="btn btn-sm btn-link custom-width" title="Answer-1"
																href="${pageContext.request.contextPath}/editEmployee?id=${candidate.id}"
																style="color: white; background: #CDDC39;"><i class="fa fa-question-circle"></i></a>	
															
															<a class="btn btn-sm btn-primary custom-width" title="Answer-2"
																href="${pageContext.request.contextPath}/editEmployee?id=${candidate.id}"
																style="color: white;"><i class="fa fa-question-circle"></i></a>
																
															<a class="btn btn-sm btn-success custom-width" title="Answer-3"
																href="${pageContext.request.contextPath}/editEmployee?id=${candidate.id}"
																style="color: white;"><i class="fa fa-question-circle"></i></a>
													</tr>
												</c:forEach>
