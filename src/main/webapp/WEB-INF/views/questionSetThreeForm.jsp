...
<body>
	...
	<div class="page-head">
		...
		<h2 class="pull-left" style="color: #428bca;">30th day's Questionnaires</h2>
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST" name="reg"
								id="questionSetThreeForm" class="form-horizontal"
								modelAttribute="command"
								action="${pageContext.request.contextPath}/saveQuestionSet3">

								<div class="form-group">
									<label class="col-lg-3 control-label">1. How was your 1st month experience with the organization?<span
										class="red">*</span>:
									</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">2. Are you satisfied with your Department/Team?<span
										class="red">*</span>:
									</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">3. Are you enjoying your job? <span
										class="red">*</span>:
									</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">4. Are you satisfied with company's HR policies? <span
										class="red">*</span>:
									</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">5. Considering everything, are you happy to work with this organization? <span
										class="red">*</span>:
									</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">6. Do you have any suggestion regarding our joining process?<span
										class="red">*</span>:
									</label>
									<div class="col-lg-5">
										<form:input id="answerSix" path="answerSix"
											class="form-control" /> 									
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-lg-3 control-label pull-left">7. How likely is it that you would recommend this company to a friend or relative? <span
										class="red">*</span>:
									</label> 
            ...
            $(function () {
                ...
                $("form[name='reg']").validate({
                    ...
                    messages: {
                    	...
                    	answerSix: "Please enter any suggestion regarding our joining process."
                    },
