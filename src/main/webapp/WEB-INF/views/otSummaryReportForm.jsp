...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Overtime Summary Report</h2>
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="GET"
								id="otSummaryReportFormId" class="form-horizontal"
								action="${pageContext.request.contextPath}/generateOtSummaryReport">
