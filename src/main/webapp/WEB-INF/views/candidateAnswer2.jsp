								...
								<div class="form-group">
									...
									<div class="col-lg-5">										
										...
										<c:if test="${candidateAnswer.answerOne eq 1}"> 
											<p class="bold" style="color:#00000; font-size:2em;">Strongly Disagree </p>
										</c:if>		
										<c:if test="${candidateAnswer.answerOne eq 2}"> 
											<p class="bold" style="color:#00000; font-size:2em;">Disagree </p>
										</c:if>
										<c:if test="${candidateAnswer.answerOne eq 3}"> 
											<p class="bold" style="color:#00000; font-size:2em;">Neither Agree Nor Disagree</p>
										</c:if>
										<c:if test="${candidateAnswer.answerOne eq 4}"> 
											<p class="bold" style="color:#00000; font-size:2em;">Agree </p>
										</c:if>
										<c:if test="${candidateAnswer.answerOne eq 5}"> 
											<p class="bold" style="color:#00000; font-size:2em;">Strongly Agree </p>
										</c:if>	
									</div>
								</div>
								<div class="form-group">
